export const environment = {
  ...
  new_http_url:"http://localhost:9000/api",//https://applus-api.activitypro.co.uk:1026/api
  ...
  new_graphql_url:"http://localhost:9000/graphql",//https://applus-api.activitypro.co.uk:1026/graphql
